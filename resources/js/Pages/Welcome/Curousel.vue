...
const images = ref<object>([
    'https://4kwallpapers.com/images/walls/thumbs_3t/19518.png',
    'https://4kwallpapers.com/images/walls/thumbs_3t/17277.jpg',
    'https://4kwallpapers.com/images/walls/thumbs_3t/19746.jpg',
    'https://4kwallpapers.com/images/walls/thumbs_3t/20019.jpg',
    'https://4kwallpapers.com/images/walls/thumbs_3t/7710.jpg'
])

</script>
<template>
    <!-- <div id="default-carousel" class="relative w-full" data-carousel="slide">
        <div class="relative h-20 overflow-hidden md:h-14 "
            style="box-shadow: rgba(0, 0, 205, 0.4) 0px 20px 30px -10px;">
        ...
        <div class="absolute z-30 flex -translate-x-1/2 bottom-5 left-1/2 space-x-3 rtl:space-x-reverse">
            <button v-for="(item, key) in images" type="button" class="w-2 h-2 rounded-full" aria-current="true"
                :aria-label="'Slide' + key" :data-carousel-slide-to="key">
            </button>
        </div>
    </div> -->
    <div class="background">
        <div class="flex flex-col sm:flex-row gap-4">
            <div class="w-full sm:w-1/2 mt-4 sm:mt-20 p-10 text-white">
                <h1 class="text-4xl md:text-6xl font-bold leading-tight p-5">
                    Build Your Dream Website
                </h1>
                <p class="mt-2 text-lg md:text-xl text-gray-1000 p-10">
                    Create stunning websites and web applications with ease using our tools and services.
                </p>

            </div>
            <div class="w-full sm:w-1/2  mt-4 sm:mt-20 p-10 text-white">
                <div class="w-full p-6 bg-[#10131671] border border-[#27344a] rounded-lg space-y-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2">
                            <div class="w-10">
                                <svg fill="#000000" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                                    ...
                                    <g id="SVGRepo_iconCarrier">
                                        ...
                                        <polygon style="fill:#e44f26"
                                            points="5.902 27.201 3.655 2 28.345 2 26.095 27.197 15.985 30 5.902 27.201">
                                        </polygon>
                                        <polygon style="fill:#f1662a"
                                            points="16 27.858 24.17 25.593 26.092 4.061 16 4.061 16 27.858"></polygon>
                            ...
                            <div class="w-[38px] ml-0.5">
                                <svg fill="#000000" preserveAspectRatio="xMidYMid"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg"
                                    version="1.1" viewBox="0 -51 256 256">
                                    <g stroke-width="0" id="SVGRepo_bgCarrier"></g>
                                    <g stroke-linejoin="round" stroke-linecap="round" id="SVGRepo_tracerCarrier"></g>
                                    <g id="SVGRepo_iconCarrier">
                                        <defs>
                                            <linearGradient id="linearGradient-1" y2="67.5555556%" x2="100%" y1="32%"
                                                x1="-2.77777778%">
                    ...
                    <p class="text-slate-400 text-sm">
                        consectetur adipisicing elit. Molestias distinctio hic quam minima, ab sunt
                        culpa laborum doloremque nobis natus.
                    </p>
                    <div class="flex items-center gap-3 text-[13px] text-zinc-200 font-medium">
                        <span>HTML + Tailwindcss</span>
                    </div>
                    <div id="default-carousel" class="relative " data-carousel="slide">

                        <div class="relative h-32 overflow-hidden md:h-60  rounded-lg"
                            style="box-shadow: rgba(0, 0, 205, 0.4) 0px 20px 30px -10px;">
                        ...
                        <div
                            ...
                            <button v-for="(item, key) in images" type="button" class="w-2 h-2 rounded-full"
                                aria-current="true" :aria-label="'Slide' + key" :data-carousel-slide-to="key">
                            </button>
                        </div>
                    </div>
                </div>
...
<style scoped>
.background {
    background-image: url('https://wallpapershome.com/images/pages/pic_h/666.jpg');
