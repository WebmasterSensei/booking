<template>
    <AuthenticatedLayout>
        <div class="container mx-auto px-4 mt-3">
            <div>
                <n-button @click="showModal" type="info">
                   Add Available Rooms
                </n-button>
            </div>
            <div class="grid-cols-1 sm:grid md:grid-cols-3 ">
                <div v-for="item in props.records" :key="item.id">
                    <div
                        ...
                        <div
                            class="w-full max-w bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                            <a href="#">
                                <img class="p-8 rounded-t-lg"
                                    :src="'/storage/roomimage/' + item.image" />
                            </a>
                            <div class="px-5 pb-5">
                                <a href="#">
            ...
            <AddRoomsModal @closeModal="closeModal" :style="res.responsive ? 'width: 100%' : 'width: 50%'"
...
import { ref } from 'vue';
import AddRoomsModal from './AddRoomsModal.vue';
import { useWindowStore } from '../../Utils/store';
