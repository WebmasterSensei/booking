            ...
            <div class="grid-cols-1 sm:grid md:grid-cols-3 ">
                <div
                    ...
                    <div
                        ...
                        <a href="#">
                            <img class="p-8 rounded-t-lg" src="https://tecdn.b-cdn.net/img/new/standard/city/042.webp"
                                alt="product image" />
                        </a>
                        <div class="px-5 pb-5">
                            <a href="#">
             ...
             <AddRoomsModal  v-model:show="addModal"></AddRoomsModal>
...
import { useWindowStore } from '../../Utils/store.js';

const windowStore = useWindowStore();

// Update widthSize on window resize


const widthSize = windowStore.updateWidth();
// alert(widthSize)
